...
def download_golden_data(artifact_dir: str, dataset: str) -> pd.DataFrame:
    ...
    id_dict: Dict[str, str] = {
        "common_golden_stats.csv": "1t0nl6LLq4WEVNHbasULLQ1onQQtxLL6A",
        "lite_golden_stats.csv": "1D9LWg78K66kHnex5RopBbTu_rwz1fhaS",
        "verified_golden_stats.csv": "1M6KZyLezU8ut0hrKUJBwi_TpvHV437NB",
    }
    assert (
    ...
    if not os.path.isfile(file_dir):
        ...
        try:
            ...
            gdown.download(id=id_dict[dataset_file], output=file_dir, quiet=False)
